...
import style from './JoinNavbar.module.css'
...
function NavBar() {
  ...
  return (
    ...
    <div className={style.Wrapper}>
     ...
     <span style={{color:'white',width:'150px',display:'flex',marginTop:'10px'}}>Subscribed ?➡️</span>
   <button className={style.joinUs}  onClick={(()=> openInNewTab('http://localhost:3000/Pricing') )}>Subscribe</button>
